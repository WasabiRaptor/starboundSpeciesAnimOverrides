function setCosmetic.head(cosmetic)
	if type(cosmetic)=="table" and not self.hideHead then
...
function setCosmetic.chest(cosmetic)
	if type(cosmetic)=="table" and not self.hideChest then
...
function setCosmetic.legs(cosmetic)
	if type(cosmetic)=="table" and not self.hideLegs then
...
function setCosmetic.back(cosmetic)
	if type(cosmetic)=="table" and not self.hideBack then
